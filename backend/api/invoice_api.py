...
# GET ALL INVOICES
# ---------------------------------
@invoice_api.route("/api/invoices", methods=["GET"])
def get_invoices():
...
# GET ONE INVOICE
# ---------------------------------
@invoice_api.route("/api/invoices/<int:id>", methods=["GET"])
def get_invoice(id):
...
# CREATE INVOICE
# ---------------------------------
@invoice_api.route("/api/invoices", methods=["POST"])
def create_invoice():
...
# UPDATE INVOICE
# ---------------------------------
@invoice_api.route("/api/invoices/<int:id>", methods=["PUT"])
...
# DELETE INVOICE
# ---------------------------------
@invoice_api.route("/api/invoices/<int:id>", methods=["DELETE"])
...
# ---------------------------------
@invoice_api.route("/api/invoices/<int:invoice_id>/items", methods=["GET"])
